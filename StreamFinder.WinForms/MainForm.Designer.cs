namespace StreamFinder.WinForms
{
    partial class MainForm
    {
        ...
        private System.Windows.Forms.Button btnDiscoverNavigation;
        ...
        private System.Windows.Forms.ComboBox cmbDiscoveryLanguage;
        private System.Windows.Forms.Label lblDiscoveryLanguage;
        ...
        private void InitializeComponent()
        {
            ...
            btnDiscoverNavigation = new System.Windows.Forms.Button();
            ...
            cmbDiscoveryLanguage = new System.Windows.Forms.ComboBox();
            lblDiscoveryLanguage = new System.Windows.Forms.Label();
            ...
            panelSidebar.Controls.Add(btnDiscoverNavigation);
            ...
            ConfigureNavigationButton(btnDiscoverNavigation, "Descobrir", 228);
            ...
            btnDiscoverNavigation.Click += new System.EventHandler(btnDiscoverNavigation_Click);
            ...
            btnDiscover.Text = "Descobrir";
            btnDiscover.Dock = System.Windows.Forms.DockStyle.Fill;
            btnDiscover.Font = new System.Drawing.Font("Segoe UI", 10F);
            btnDiscover.Enabled = false;
            btnDiscover.Visible = false;
            btnDiscover.Click += new System.EventHandler(btnDiscover_Click);
            ...
            panelTop.Controls.Add(lblDiscoveryLanguage, 2, 2);
            panelTop.Controls.Add(cmbDiscoveryLanguage, 3, 2);
                        panelTop.Controls.Add(btnDiscover, 4, 2);
            panelTop.SetColumnSpan(chkOwnedOnly, 2);
            lblDiscoveryLanguage.Text = "Idioma:";
            lblDiscoveryLanguage.TextAlign = System.Drawing.ContentAlignment.MiddleRight;
            lblDiscoveryLanguage.Font = new System.Drawing.Font("Segoe UI", 9F);
            lblDiscoveryLanguage.Visible = false;
            ConfigureCombo(cmbDiscoveryLanguage, new[] { "Qualquer idioma", "Português original", "Português original ou possivelmente dublado" }, 0, "Idioma");
